...
UGCCustomGameAttributeType = { 
	--Character [最大魔法值-MagicMax],
	UGCAttributeGroup_Character_MagicMax = 'MagicMax',
	--Character [魔法-Magic],
	UGCAttributeGroup_Character_Magic = 'Magic',
	--Character [攻击-Attack],
	UGCAttributeGroup_Character_Attack = 'Attack',
	--Character [转世-Live],
	UGCAttributeGroup_Character_Live = 'Live',
	--Character [等级-Level],
	UGCAttributeGroup_Character_Level = 'Level',
	--Character [天赋点-PlayerTalentPoints],
	UGCAttributeGroup_Character_PlayerTalentPoints = 'PlayerTalentPoints',
	--Character [战斗力-UGCPlayerCombatPower],
	UGCAttributeGroup_Character_UGCPlayerCombatPower = 'UGCPlayerCombatPower',
	--Character [经验-EXP],
	UGCAttributeGroup_Character_EXP = 'EXP',
	--Character [额外吞噬-Ecexp],
	UGCAttributeGroup_Character_Ecexp = 'Ecexp',
	--Character [血脉-bland],
	UGCAttributeGroup_Character_bland = 'bland',
	--Character [无尽层数-cengshu],
	UGCAttributeGroup_Character_cengshu = 'cengshu',
}; 

UGCCustomGameAttributeTypeCommentMap = { 
	['MagicMax'] = 'Character [最大魔法值-MagicMax]', 
	['Magic'] = 'Character [魔法-Magic]', 
	['Attack'] = 'Character [攻击-Attack]', 
	['Live'] = 'Character [转世-Live]', 
	['Level'] = 'Character [等级-Level]', 
	['PlayerTalentPoints'] = 'Character [天赋点-PlayerTalentPoints]', 
	['UGCPlayerCombatPower'] = 'Character [战斗力-UGCPlayerCombatPower]', 
	['EXP'] = 'Character [经验-EXP]', 
	['Ecexp'] = 'Character [额外吞噬-Ecexp]', 
	['bland'] = 'Character [血脉-bland]', 
	['cengshu'] = 'Character [无尽层数-cengshu]', 
}; 
