---@class bossxt_6_C:UGCGenericCharacterPositionWidget
---@field ProgressBar_0 UProgressBar
---@field TextBlock_name UTextBlock
---@field TextBlock_percent UTextBlock
--Edit Below--
local bossxt = { bInitDoOnce = false }

-- 角色名字变化回调
---@param Name FName
function bossxt:BP_CharacterNameChange(Name)
...
function bossxt:BP_CharacterHPChange(InHPCurrent, InHPMax)
    if InHPMax > 0 then
...
-- 初始化参数完成回调
function bossxt:Event_InitParamEnd()
end
