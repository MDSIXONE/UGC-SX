---@class bailangjian_C:PESkillPassiveSkillTemplate_C
...
function jinse:OnApply_BP()
    ...
    if not self:HasAuthority() then
        ...
        self.ParticleSystemComponent = GameplayStatics.SpawnEmitterAttachedToActor(self.Particle, Character.Mesh, "root", Vector.New(-45, -40, 90), Rotator.New(-90, 0, 0), Vector.New(1.8, 1.8, 1.8), EAttachLocation.SnapToTarget, true)
    end
end
